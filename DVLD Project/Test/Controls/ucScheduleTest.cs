...
namespace DVLD_Project.Test.Controls
{
    public partial class ucScheduleTest : UserControl
    {
        ...
        {
            if (_Mode == enMode.AddNew && clsLocalDriveLicense.IsThereAnActiveScheduledTest(_LocalDrivingLicenseApplicationID, _TestTypeID))
            {
        ...
        private bool _HandlePrviousTestConstraint()
        {
            ...
            switch (TestTypeID)
            {
                ...
                case clsTestType.enScheduleTest.Writen:
                    ...
                    if (!_LocalDrivingLicenseApplication.DoesPassTestType(clsTestType.enScheduleTest.vision))
                    {
                ...
                case clsTestType.enScheduleTest.Street:
                    ...
                    if (!_LocalDrivingLicenseApplication.DoesPassTestType(clsTestType.enScheduleTest.Writen))
                    {
